...
export const icons = {
  ...
  javascript: <JavaScript width={width} height={height} />,
  react: <ReactIcon width={width} height={height} />,
  mui: <MUI width={width} height={height} transform="scale(0.8)" />,
  axios: <Axios width={width} height={height} transform="scale(4.5)" />,
  bootstrap: <Bootstrap width={width} height={height} transform="scale(0.9)" />,
  sass: <Sass width={width} height={height} transform="scale(0.9)" />,
  git: <Git width={width} height={height} transform="scale(0.9)" />,
  redux: <Redux width={width} height={height} transform="scale(0.9)" />,
  tailwind: <Tailwind width={width} height={height} transform="scale(0.9)" />,
};
